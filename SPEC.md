# 📄 Project Specification: 그린 포레스트

## 1. 개요 (Overview)
본 프로젝트는 20명 규모 임직원을 위한 식물 RPG 커뮤니티 웹앱입니다. 분할 격자 이미지를 메인 인터페이스로 사용하는 시각 중심 커뮤니티 플랫폼이며, 물방울(포인트) 시스템과 파티 랭킹을 통해 참여를 유도합니다.
